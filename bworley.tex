...
\item{
  {\it Staff Scientist, Machine Learning}
  \hfill 2019--present. \\
  Atomwise \\
  Supervisor: Izhar Wallach \\
  \begin{enumerate*}
...
% \item \textbf{B. Worley},
%  Variationally reweighted least squares for sparse recovery,
%  \emph{IEEE Transactions on Signal Processing},
%  In preparation.

 \item The Atomwise AIMS Team, AI is a viable alternative to
  high-throughput screening: a 318-target study,
